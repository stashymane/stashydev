    ...
    get() {
        ...
        _LogoGithub = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                arcToRelative(102.4f, 102.4f, 0f, isMoreThanHalf = false, isPositiveArc = true, -22.6f, 2.7f)
                ...
                arcToRelative(208.21f, 208.21f, 0f, isMoreThanHalf = false, isPositiveArc = true, 112.2f, 0f)
